...
def generate_launch_description():
    ...
    robot_dir = os.path.join(workspace_dir, 'robots', 'anymal_c')
    urdf_file = os.path.join(robot_dir, 'anymal_c_urdf', 'urdf', 'anymal.urdf')
    mesh_dir = os.path.join(robot_dir, 'anymal_c_urdf', 'meshes')
    ...
    rviz_config_file = os.path.join(scripts_dir, 'rviz', 'anymal_c.rviz')
