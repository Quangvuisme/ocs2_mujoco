...
KeyboardController::KeyboardController() {
    ...
    std::cout << "[Keyboard] ANYmal Standing Controller initialized" << std::endl;
    ...
    std::cout << "  1: STANDING mode" << std::endl;
    std::cout << "  2: PASSIVE mode" << std::endl;
    std::cout << "  3: RECOVERY mode" << std::endl;
    std::cout << "  4/R: Reset to default pose" << std::endl;
            ...
            if (nread > 0) {
                if (seq[0] == '\x1b') {
                    ...
                    switch (c) {
                        ...
                        // Mode selection: 1=STANDING, 2=PASSIVE, 3=RECOVERY
                        case '1': modeChangeRequest_.store(1); break;  // STANDING
                        case '2': modeChangeRequest_.store(0); break;  // PASSIVE
                        case '3': modeChangeRequest_.store(2); break;  // RECOVERY
                        
                        // Reset pose
                        case '4': case 'r': case 'R': resetPressed_.store(true); break;
...
bool KeyboardController::wasResetPressed() { return resetPressed_.exchange(false); }
