...
def generate_launch_description():
    ...
    robot_dir = os.path.join(workspace_dir, 'robots', 'go1')
    urdf_file = os.path.join(robot_dir, 'go1_urdf', 'urdf', 'go1.urdf')
    mesh_dir = os.path.join(robot_dir, 'go1_urdf', 'meshes')
    ...
    rviz_config_file = os.path.join(scripts_dir, 'rviz', 'go1.rviz')
