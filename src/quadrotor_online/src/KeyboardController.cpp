            ...
            if (nread > 0) {
                if (seq[0] == '\x1b') {
                    ...
                    switch (c) {
                        ...
                        case '1': targetChangeRequest_.store(0); break;
                        case '2': targetChangeRequest_.store(1); break;
                        case '3': targetChangeRequest_.store(2); break;
                        case '4': targetChangeRequest_.store(3); break;
...
int KeyboardController::getTargetChangeRequest() { return targetChangeRequest_.exchange(-1); }
